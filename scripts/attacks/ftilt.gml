...
set_window_value(AT_FTILT, 1, AG_WINDOW_SFX, asset_get("sfx_bite"));
...
set_hitbox_value(AT_FTILT, 1, HG_WIDTH, 120);
...
set_hitbox_value(AT_FTILT, 1, HG_KNOCKBACK_SCALING, .55);
