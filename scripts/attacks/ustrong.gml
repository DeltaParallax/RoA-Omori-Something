...
set_hitbox_value(AT_USTRONG, 1, HG_HEIGHT, 160);
...
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, HFX_GEN_BIG);
...
set_hitbox_value(AT_USTRONG, 2, HG_HITBOX_Y, -160);
...
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, sound_get("sfx_critical_hit"));
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, vfx_dattack_sweet);
