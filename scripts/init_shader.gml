...
{
    set_character_color_slot( 0, 255, 255, 255 ); //outline
    set_character_color_slot( 1, 124, 124, 124 ); //highlight 1
    set_character_color_slot( 2, 72, 72, 72 ); //highlight 2
    set_character_color_slot( 3, 0, 0, 0 ); //body color
    ...
    set_article_color_slot( 2, 72, 72, 72 ); //highlight 2
    set_article_color_slot( 3, 0, 0, 0 ); //body color
