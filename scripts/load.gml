...
sprite_change_offset("spinhurt", 52, 82);
sprite_change_offset("crouch", 52, 88);
sprite_change_offset("walk", 20, 92);
sprite_change_offset("walkturn", 18, 90);
sprite_change_offset("dash", 58, 62);
sprite_change_offset("dashstart", 52, 70);
...
sprite_change_offset("pratland", 56,80);
...
sprite_change_offset("utilt", 72, 114);
sprite_change_offset("nair", 68, 100);
sprite_change_offset("fair", 34, 100);
sprite_change_offset("bair", 132, 96);
